...
/**
 * Iterator over subdocument at given path in the dataholder. The path can point
 * to an array or an object node.
 *
 */
	...
	public IDataHolder next() {
		...
		if (isObjectNode) {
			if (objectNodeIterationDone) {
				...
				IDataHolder dataHolder = new JsonDataHolder();
